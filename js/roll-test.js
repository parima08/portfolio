(function() {
  ...
  // initiate roll
  var roll = Roll.DOM( "#wrapper", "#pane", "#steps", ".step", 400 );
  console.log(roll);
  ...
  function track() {
    ...
    roll.on( "roll", function ( step, stepProgress, position, totalProgress ) {
      ...
      console.log("currPos is: " + vals["currPos"]);
      console.log("currStep is: " + vals["currStep"]);
      console.log("viewportHeight is: " + vals["viewportHeight"]);
      console.log("paneHeight is: " + vals["paneHeight"]);
      // for (var k in vals) {
      ...
      // var step_ids = ["#introduction", "#about", "#web_apps"];
      // console.log(views[1]);
      if (step >= 0) {
        var currStep = views[step];
